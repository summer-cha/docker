...
⚠️ **首次访问提示**：由于使用自签名证书，浏览器会提示不安全，点击"继续访问"即可。
...
- [LinuxServer.io 项目](https://github.com/linuxserver/docker-bambustudio)
- [Bambu Studio 官方下载](https://bambulab.com/en/download/studio)
- [Bambu Lab 官网](https://bambulab.com/)
- [使用文档](https://wiki.bambulab.com/)

## 更新日志

当前版本基于 LinuxServer.io 的 Bambu Studio 镜像，会定期更新到最新版本。

---

**提示**：首次启动可能需要 30-60 秒加载完整界面，请耐心等待。建议使用 Chrome/Edge 浏览器以获得最佳体验。
